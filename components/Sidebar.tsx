...
export default function Sidebar() {
 ...
 <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-56 bg-white shadow-lg z-50 transform transition-transform duration-300
      ...
      >
        ...
        <a href="#" className="block hover:bg-gray-400 p-2 rounded">
        ...
        <a href="#" className="block hover:bg-gray-400 p-2 rounded">
            <MdOutlineHelpOutline className="inline text-2xl" /> Help & Support
        </a>
        <a href="/" className="block hover:bg-gray-400 p-2 rounded" onClick={logout}>
            <IoExitOutline className="inline" /> Log Out {user?.email}
        </a>
        </footer>
      </aside>
    </>
        ...
        //                 onClick={logout}
        //             >
        //                 <IoExitOutline className="inline text-2xl" /> Log Out{" "}
        //                 {user?.email}
        //             </a>
        //         </footer>
        //     </aside>
